              ...
              <div class="card-body">
                  <div class="row">
					  ...
					  if($this->session->userdata('userlevel')=='1'){
						  ?>
					  <div class="col-3"><button type='button' class='btn btn-info tambah' >Mapping Barang</button></div>					  
					  <div class="col-9"></div>					  
						  <?php
					  }
                          ...
                          <table id='datatableberita' class="table table-bordered table-striped" width='100%'>		
							<thead>
								<tr>
									...
									<th align='center' width='25%'>Nomor Registrasi</th>
									<th align='center' width='25%'>Penanggung Jawab</th>
									<th align='center'  width='30%'>Kondisi</th>
...
<script>				
	...
	$(document).on('click','.tambah',function(){
					$('#tampil_form').load("<?=site_url()?>/Barang/form_history"+ "/"+ $("#jenis").val(),function(){
					$('#modal_form').modal('show');
					});
				});
